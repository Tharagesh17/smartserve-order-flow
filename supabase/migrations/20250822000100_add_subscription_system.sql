...
-- 3) Order tracking for subscription limits
...
-- 3) Add order tracking for subscription limits
...
-- 4) Add subscription fields to restaurants table
...
-- Function to get user's order count for a restaurant
...
-- Function to increment user's order count
...
-- Insert subscription plans that match existing Razorpay plans
